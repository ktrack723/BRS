...
| 레버 | 채점? | 실제로 하는 일 |
|---|---|---|
| ✂️ **스타일링** | ❌ | 고객 **외모** 시트를 통째로 다시 쓴다. 3D 아바타도 같이 바뀐다 |
| 🔥 **동기부여** | ❌ | 고객 **성격** 시트를 통째로 다시 쓴다. 어떤 인간으로 그 자리에 앉을지가 여기서 정해진다 |
| 🎧 **코칭** | ❌ | 대화 프롬프트에 **명령**으로 박힌다. 비우면 고객은 준비 없이 제 시트대로만 움직인다 |
