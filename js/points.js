...
// 말투를 넣기 전 심판은 코칭 판에 ▲를 23% 줬고 그때는 12가 맞았다. 지금은 43%를 준다
// (8차 실측) — 12를 그대로 두면 아무것도 안 한 판까지 12.8%가 성사된다. 20으로 되돌리면
// 무입력 1.9% · 코칭 11.3%가 된다. 심판이 다시 얌전해지면 이 숫자도 같이 내려야 한다.
//
