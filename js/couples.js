...
const REGARD = {
  ...
  asmr:          { client: '매 영상마다 못 잤다고 쓴다. 5년간 한 번도 다르게 쓴 적이 없다',
                   target: '이 사람 목소리가 3년간 내 귀에서 안 나간다. 병원에서는 원인 불명이라고 한다' },
  spice:         { client: '매번 "또 오셨네요"만 한다. 말릴 거면 제대로 말리든가',
                   target: '이 사람 위벽이 어떻게 생겼는지 나는 안다. 그걸 알면서 매달 예약을 받는 게 내 일이다' },
