...
chk "warm의 기준이 한국 커플 밀당 수준" "grep -q '밀당' js/prompts.js && grep -q 'who moves first and neither will admit' js/prompts.js"
chk "warm은 두근거림의 출처를 요구한다" "grep -q 'which line, and what about this' js/prompts.js && grep -q 'Wit is not a source' js/prompts.js"
